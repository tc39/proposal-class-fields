...
- Instance class fields are [available under flag](https://bugzilla.mozilla.org/show_bug.cgi?id=1529758) in Firefox 67, private fields are supported by parser, but behave as public fields
